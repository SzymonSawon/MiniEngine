...
draw_model_object :: proc(object: ^Object, system: ^System, vao: VAO, tex_id: u32, light_source_pos: linalg.Vector3f32) {
    gl.UseProgram(object.shader.program)
    object.m = linalg.identity_matrix(linalg.Matrix4x4f32)
    object.m= linalg.matrix4_translate_f32(linalg.Vector3f32({object.position[0],object.position[1],object.position[2]})) * object.m
    system.mvp = system.camera.p * system.camera.v
    system.mvp = system.mvp * object.m

    gl.UniformMatrix4fv(gl.GetUniformLocation(object.shader.program, "MVP"), 1, gl.FALSE, &system.mvp[0][0])
    gl.UniformMatrix4fv(gl.GetUniformLocation(object.shader.program, "model"), 1, gl.FALSE, &object.m[0][0])
    gl.UniformMatrix4fv(gl.GetUniformLocation(object.shader.program, "view"), 1, gl.FALSE, &system.camera.v[0][0])
    gl.UniformMatrix4fv(gl.GetUniformLocation(object.shader.program, "projection"), 1, gl.FALSE, &system.camera.p[0][0])
    ...
    gl.Uniform3f(gl.GetUniformLocation(object.shader.program, "mtlAmbient"), object.model_data.material.ambient[0], object.model_data.material.ambient[1], object.model_data.material.ambient[2])
    gl.Uniform3f(gl.GetUniformLocation(object.shader.program, "mtlDiffuse"), object.model_data.material.diffuse[0], object.model_data.material.diffuse[1], object.model_data.material.diffuse[2])
    gl.Uniform3f(gl.GetUniformLocation(object.shader.program, "mtlSpecular"), object.model_data.material.specular[0], object.model_data.material.specular[1], object.model_data.material.specular[2])
    gl.Uniform1f(gl.GetUniformLocation(object.shader.program, "mtlSpecularExponent"), object.model_data.material.specular_exponent)
    gl.ActiveTexture(gl.TEXTURE0 + tex_id)
